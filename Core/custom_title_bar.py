...
class CustomTitleBar(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        font_icon = QFont() 
        font_icon.setPointSize(TITLE_FONT_SIZE - 2) 
    ...
    def _apply_styles(self):
        ...
        self.setStyleSheet(f"""
            ...
            QLabel#titleBarLabel {{
                ...
                font-size: {TITLE_FONT_SIZE - 4}pt; 
                font-weight: bold;
                padding-left: 5px;
            ...
            QComboBox#languageComboBox::drop-down {{
                ...
                border-left-width: 1px; border-left-color: {SUBTEXT_COLOR}; border-left-style: solid;
            ...
            QPushButton#closeButton:hover {{
                background-color: rgba(200, 90, 110, 0.75); 
                color: white;
            }}
